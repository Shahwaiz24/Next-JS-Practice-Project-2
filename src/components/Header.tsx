...
const Header = () => {
    ...
    return (
        <div className='w-full py-8 fixed  z-[999] px-[4vw] flex items-center justify-between text-white '>
            <div className='logo'>
            ...
            <div className='links  items-center xl:gap-12 gap-8 hidden lg:flex '>
                {links.map((e, index) => {
                    return (
                        <Link href={e.link} key={index} className={`${index === 4 && "ml-54 "} capitalize text-light  xl:text-lg text-md`}>{e.label}</Link>
                    );
                })}
            </div>
